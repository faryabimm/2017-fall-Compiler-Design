...
public class DraculaParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_int = 1, RULE_name = 2, RULE_double = 3, RULE_deffunc = 4, 
	...
	public static final String[] ruleNames = {
		"program", "int", "name", "double", "deffunc", "defvar", "def", "assign", 
	...
	public static class IntContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DraculaListener ) ((DraculaListener)listener).enterInt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DraculaListener ) ((DraculaListener)listener).exitInt(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DraculaVisitor ) return ((DraculaVisitor<? extends T>)visitor).visitInt(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final IntContext int() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_int);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(38);
	...
	public static class DoubleContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof DraculaListener ) ((DraculaListener)listener).enterDouble(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof DraculaListener ) ((DraculaListener)listener).exitDouble(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof DraculaVisitor ) return ((DraculaVisitor<? extends T>)visitor).visitDouble(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final DoubleContext double() throws RecognitionException {
		...
		enterRule(_localctx, 6, RULE_double);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(42);
