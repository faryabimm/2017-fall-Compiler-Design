...
public interface DraculaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DraculaParser#int}.
	 * @param ctx the parse tree
	 */
	void enterInt(DraculaParser.IntContext ctx);
	/**
	 * Exit a parse tree produced by {@link DraculaParser#int}.
	 * @param ctx the parse tree
	 */
	void exitInt(DraculaParser.IntContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DraculaParser#double}.
	 * @param ctx the parse tree
	 */
	void enterDouble(DraculaParser.DoubleContext ctx);
	/**
	 * Exit a parse tree produced by {@link DraculaParser#double}.
	 * @param ctx the parse tree
	 */
	void exitDouble(DraculaParser.DoubleContext ctx);
	/**
