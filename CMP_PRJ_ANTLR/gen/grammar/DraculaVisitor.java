...
public interface DraculaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DraculaParser#int}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt(DraculaParser.IntContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DraculaParser#double}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDouble(DraculaParser.DoubleContext ctx);
	/**
